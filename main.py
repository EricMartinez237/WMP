...
class VisualizerRenderer:
    ...
    def render(self, bass: float, mid: float, treble: float, beat: bool) -> None:
        ...
        for halo in self.halos:
            ...
            r = br * (1 - life_fraction) + self.bg_color[0]*life_fraction
            g = bg * (1 - life_fraction) + self.bg_color[1]*life_fraction
            b = bb * (1 - life_fraction) + self.bg_color[2]*life_fraction
